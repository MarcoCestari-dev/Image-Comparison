...
- Se si vuole utilizzare Visual Studio Community per la modifica dei file **potrebbe** essere necessario fare lo sblocco dei file resx che automaticamente vengono bloccati quando scaricati da internet. Per sbloccarli aprire il zip e portare la cartella nella posizione desiderata, premere SHIFT e Click Destro nella cartella e aprire una PowerShell e inviare il seguente comando: _"Unblock-File *"_
