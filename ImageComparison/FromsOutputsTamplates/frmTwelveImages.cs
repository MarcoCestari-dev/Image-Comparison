...
{
    public partial class frmTwelveImages : Form
    {
        public frmTwelveImages()
        {
            InitializeComponent();
        }
        ...
        private void pbOutput10_DoubleClick(object sender, EventArgs e)
        {
            callImageView(9);
        }

        private void pbOutput11_DoubleClick(object sender, EventArgs e)
        {
            callImageView(10);
        }

        private void pbOutput12_DoubleClick(object sender, EventArgs e)
        {
            callImageView(11);
        }
